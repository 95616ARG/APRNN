...
def test_linear():
    ...
    sx = solver.reals((3, 5))
    cx = sytorch.rand(sx.shape)
    cw = sytorch.rand(fc.weight.delta.shape)
    cb = sytorch.rand(fc.bias  .delta.shape)
...
def test_conv2d():
    ...
    cx = sytorch.rand(sx.shape)
    cw = sytorch.rand(conv.weight.delta.shape)
    cb = sytorch.rand(conv.bias  .delta.shape)
